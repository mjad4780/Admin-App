...
class _ApiService implements ApiService {
  ...
  @override
  Future<ResponseDashboard> viewdashboard() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch(_setStreamType<ResponseDashboard>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value = ResponseDashboard.fromJson(jsonDecode(_result.data)!);
    return _value;
  }
